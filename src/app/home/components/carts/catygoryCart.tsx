...
const CatygoryCart = (product: Props) => {
    ...
    <div key={product.id} className="w-[233px] ">
      <div className="shadow hover:shadow-lg transition duration-300 ease-in-out xl:mb-0 lg:mb-0 md:mb-0 mb-6 cursor-pointer group">
        <div className="overflow-hidden relative">
          <img
            className="w-[223px] h-[223px] transition duration-700 ease-in-out group-hover:opacity-0"
            src={product.images[0]?.image}
            alt="image"
          />
          <img
            className="w-[233px] transition opacity-0 absolute top-0 duration-700 ease-in-out group-hover:opacity-100"
        ...
        <div className="px-4  pt-3 pb-5 text-center  relative bg-white">
          ...
          <div className=" absolute top-[60px] z-30 right-[10px] transition translate-y-[10px] group-hover:translate-y-0 duration-500 ease-in-out opacity-0  gap-3 group-hover:opacity-100 w-[210px]  ">
            {!myCard ? (
              <Button
                onClick={() => addProduct()}
