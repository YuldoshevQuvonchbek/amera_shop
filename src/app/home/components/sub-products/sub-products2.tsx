...
export const SubProducts2 = async ({ id }: Props) => {
  ...
  return (
    <div className="mb-5">
      <Carousel>
                ...
                <div>
                  ...
                  <div className="shadow xl2:w-[330px] xl:w-[300px] md:w-[300px]  rounded hover:shadow-lg items-center bg-white pt-3 pb-3 pl-3 pr-2  flex transition duration-300 ease-in-out  mb-5 cursor-pointer group">
                    ...
                    <div className="px-4 py-3   bg-white">
                      ...
                      <h1 className="text-[#0066C0] mb-2 text-sm font-semibold  hover:primarycolor transition duration-300 ease-in-out">
                        {item[1]?.title}
                      </h1>
        ...
        <div className=" top-[-42px] right-[-229px] absolute">
          <CarouselPrevious />
          <CarouselNext />
        </div>
      </Carousel>
